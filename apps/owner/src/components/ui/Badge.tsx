...
const colorStyles: Record<BadgeColor, Record<BadgeVariant, string>> = {
  ...
  warning: {
    ...
    solid: 'bg-warning-500 text-white dark:bg-warning-400',
    subtle: 'bg-warning-50 text-warning-600 dark:bg-warning-900/20 dark:text-warning-400',
    outline: 'border-warning-300 text-warning-700 dark:border-warning-500 dark:text-warning-400',
  },
  error: {
  ...
  surface: {
    ...
    solid: 'bg-surface-600 text-white dark:bg-surface-500',
    subtle: 'bg-surface-50 text-surface-600 dark:bg-surface-800 dark:text-surface-400',
    outline: 'border-surface-300 text-surface-700 dark:border-surface-600 dark:text-surface-400',
  },
  gray: {
