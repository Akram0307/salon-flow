...
import { BookingList } from '../components/dashboard/BookingCard';
...
import type { ActivityItem, QuickAction } from '../components';
...
const mockStats = [
  ...
  },
  {
    ...
    title: 'Staff Active',
    value: '6/8',
    change: { value: 0.0, type: 'neutral' as const, period: 'on duty today' },
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
